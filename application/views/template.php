...
<body class="white-content body">
  ...
  <!--   Core JS Files   -->
  <script src="<?=base_url()?>assets/js/lordicon.js"></script>
      ...
      chart.initDashboardPageCharts();
	    ...
	    var data = {
	      ...
	      datasets: [{
	        ...
	        borderDash: [],
	        borderDashOffset: 0.0,
	        pointBackgroundColor: '#ff6491',
	        pointBorderColor: 'rgba(255,255,255,0)',
	        pointHoverBackgroundColor: '#ff6491',
	        pointBorderWidth: 20,
	        pointHoverRadius: 4,
	        pointHoverBorderWidth: 15,
	        pointRadius: 4,
	        ...
	        borderDash: [],
	        borderDashOffset: 0.0,
	        pointBackgroundColor: '#4949e7',
	        pointBorderColor: 'rgba(255,255,255,0)',
	        pointHoverBackgroundColor: '#4949e7',
	        pointBorderWidth: 20,
	        pointHoverRadius: 4,
	        pointHoverBorderWidth: 15,
	        pointRadius: 4,
	        data: [<?php foreach ($chtotprog as $data) { echo $data->total . ",";}?>],
	      }]
	    };
